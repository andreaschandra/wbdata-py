"""
wbdata-py.api: all functions
"""

#Andreas Chandra
#https://github.com/andreaschandra
#forked from https://github.com/OliverSherouse/wbdata
...
def get_data(indicator, country="all", data_date=None, convert_date=False, pandas=False, column_name="value", keep_levels=False):
    """
...
@uses_pandas
def get_panel(indicators, country="all", data_date=None, convert_date=False, items="indicators", major_axis="dates"):
    """
    Convenience function to download a set of indicators and  merge them into a
        pandas Panel.
